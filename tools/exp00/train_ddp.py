...
def main():
    ...
    args.output_dir = os.path.join(
        ...
        args.output_dir,
        f'{args.dataset}_{args.model_type}_bs{args.train_batch_size}_lr{args.learning_rate}_wd{args.weight_decay}_epochs{args.epochs}_wmsteps{args.warmup_epochs}_{args.split}_round{args.round}/'
    )
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.is_main_proc:
            ...
            with open(args.train_url + '/scores_all.tsv', "a") as f:
                f.write(
                    f"{epoch:3d}, {get_lr(optimizer)}, {loss_train}, {acc1_train}, {loss_test}, {acc1_test},\n"
                )
