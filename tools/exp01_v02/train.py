...
sys.path.append("./tools/exp01_v02/")
...
def main():
    ...
    args.output_dir = os.path.join(
        ...
        args.output_dir,
        f'{args.dataset}_{args.model_type}_bs{args.train_batch_size}_lr{args.lr}_wd{args.weight_decay}_epochs{args.epochs}_wmsteps{args.warmup_epochs}_lbd{args.lambda_0:06.2f}_round{args.round}/'
    )
...
def main_worker(local_rank, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        loss_train, acc1_train = train(train_loader, model, criterion_isda, optimizer, epoch, args)
