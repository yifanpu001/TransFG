...
from exp03_models.modeling import VisionTransformer, CONFIGS
from exp03_models.modeling_pure import VisionTransformer_pure, CONFIGS_pure
from exp03_utils.scheduler import WarmupLinearSchedule, WarmupCosineSchedule
from exp03_utils.data_utils import get_loader
from exp03_utils.dist_util import get_world_size
...
def train(args, model):
    ...
    while True:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            loss, logits = model(x, y, args.lambda_0 * (global_step / t_total))
            loss = loss.mean()
