...
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_resnet_cub.py -a resnet18 --train_batch_size 64 --eval_batch_size 64 --lr 0.4 --workers 4 --dataset CUB_200_2011 --data_root /root/data/public/CUB_200_2011 --dist-url 'tcp://127.0.0.1:12003' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0 --print-freq 20 --train_url /root/TransFG/output